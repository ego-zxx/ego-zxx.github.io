...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const closeDate = document.getElementById("closeDateModal");

  if (dateIcon && dateModal && closeDate) {
    // Show the modal
...
// Function for the button inside modal
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Close if she clicks outside the popup content
